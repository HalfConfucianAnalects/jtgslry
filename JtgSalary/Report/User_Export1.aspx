<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Export1.aspx.cs" Inherits="JtgTMS.Report.User_Export1" EnableEventValidation="false" %>
                  ...
                  <tr>                    
                    ...
                    <td width="120px">
                        <asp:DropDownList ID="ddlSignStatus" Width="100px" runat="server">
                            ...
                            <asp:ListItem Value="0" Text="已签收"></asp:ListItem>
                        </asp:DropDownList>                        
                    </td>
                    <td>
