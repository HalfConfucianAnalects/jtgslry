...
namespace JtgTMS.SysClass
{
    public class SysUserSalary
    {
        ...
        public static string UserSalary_SearchDateStart = "";
        public static string UserSalary_SearchDateEnd = "";
        public static string UserSalary_DepartmentName = "";
        ...
        public static DataSet GetWarmingLstByDataSet(string sWhereSQL)
        {
            //获取最终结果
            string sSQL = "SELECT WorkShopName, DepartmentName, SalaryDateOnly,OrganID,SalaryYears, COUNT(Num) as PersonNum FROM v_SysWarmingSummary_Info"
                + " WHERE " + sWhereSQL
                + " GROUP BY WorkShopName, SalaryDateOnly, DepartmentName, OrganID,SalaryYears";
            try
            {
        ...
        {
            string sSQL = "";
            sSQL = "select a.OpCode, b.OpName, b.Sex, b.IdNumber, a.SalaryYears,a.SalaryDate,a.TotalSalary,a.SignStatus,a.SignDate,a.SignPlatform,a.ID, c.Description"
                + " from UserSalary_Info a "
                + " left join SysUser_Info b on b.Status=0 And a.OpCode=b.OpCode"
        ...
        public static int UpdateDefaultSalarySet(string TableRecGuid, string DetailsSQL)
        {
            string sSqlText = "begin";
        ...
        public static int UpdateSingleUserSalarySet(int _UserSalaryID, string[] FieldValues, string DetailsSQL)
        {
            ...
            sSqlText += DetailsSQL + " end;";
            Debug.WriteLine("UpdateSingleUserSalarySet" + sSqlText);
            return DataCommon.QueryData(sSqlText);
        }
