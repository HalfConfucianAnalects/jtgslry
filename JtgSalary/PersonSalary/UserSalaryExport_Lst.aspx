<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserSalaryExport_Lst.aspx.cs" Inherits="JtgTMS.PersonSalary.UserSalaryExport_Lst" EnableEventValidation="false" %>
  ...
  <script type="text/javascript">
    ...
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <ul class="breadcrumb breadcrumb-button">    
                ...
                <asp:GridView ID="gvLists" name="contents" runat="server" CssClass="table table-bordered info table-hover"  GridLines="none"  style="display:none"
            ...
            <asp:GridView ID="gvList2" name="contents" runat="server" CssClass="table table-bordered info table-hover"  GridLines="none" 
                    AutoGenerateColumns="False" DataKeyNames="ID">
                    <HeaderStyle CssClass="info thead" />                 
                    <EmptyDataTemplate>
                           工资单为空。
