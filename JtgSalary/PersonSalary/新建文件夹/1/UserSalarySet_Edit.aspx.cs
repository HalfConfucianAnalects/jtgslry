    ...
    public partial class UserSalarySet_Edit : System.Web.UI.Page
    {
        ...
        private void BindPageData()
        {
            ...
            else
            {
                ...
                //    {
                //        ds.Tables[0].Rows[i]["TableRecGuid"] = SysClass.SysGlobal.GetCreateGUID();
        ...
        protected void btnApply_Click(object sender, EventArgs e)
        {
            if (SaveCheck())
            {
                ...
                SysClass.SysUserSalary.UpdateDefaultSalarySet(GetSaveDefaultPackToolMemberSQL());
        ...
        private string GetSaveDefaultPackToolMemberSQL()
        {
            ...
            Debug.WriteLine(sUpdateDefaultSQL);
        ...
        private string GetSavePackToolMemberSQL(string BillTableRecGuid)
        {
            ...
            DataSet ds = LoadOldPackToolMember("");
            Debug.WriteLine("LoadOldPackToolMember:"+GetData.ShowDataSetContent(ds));
        ...
        private DataSet LoadDefaultPackToolMember()
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                ds.Tables[0].Rows[i]["TableRecGuid"] = "";
                //ds.Tables[0].Rows[i]["ID"] = "0";
