<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserImportRecDescription_Edit.aspx.cs" Inherits="JtgTMS.DepotTool.UserImportRecDescription_Edit" %>
                    ...
                    <tr>
                        <td colspan="2" align="center" valign="top">
                             <table class="table-noborder table-hover" width="98%">
                                <tr>
                                  <td width="120" valign="top">备注：</td>
                                  <td align="left" valign="top">
                                       <asp:TextBox ID="txtDescription" MaxLength="256" Height="160" Width="400px" TextMode="MultiLine" runat="server"></asp:TextBox>
                                  </td>
                                </tr>                                                              
                              </table>
                        </td>
