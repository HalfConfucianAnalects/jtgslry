<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyNotSignUserSalary_Lst.aspx.cs" Inherits="JtgTMS.PersonSalary.MyNotSignUserSalary_Lst" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function refWindow() {
            window.location = "../PersonSalary/MyNotSignUserSalary_Lst.aspx";
        }
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                <ul class="nav nav-pills">
                    <li class="active"><a href="MyNotSignUserSalary_Lst.aspx">
                        <lan>未签收工资单</lan>
                    </a></li>
                    <li><a href="MySignUserSalary_Lst.aspx">
                        <lan>已签收工资单</lan>
                    </a></li>
                </ul>
                <div class="well well-small">
                    ...
                    <table class="table table-noborder">
                        <tr>
                            <td width="250">工资月份起始：<asp:TextBox ID="txtSalaryYears" onClick="WdatePicker({dateFmt:'yyyyMM'})" MaxLength="6" Width="120px" runat="server"></asp:TextBox>
                            </td>
                            <td width="250">工资月份结束：<asp:TextBox ID="txtSalaryYears2" onClick="WdatePicker({dateFmt:'yyyyMM'})" MaxLength="6" Width="120px" runat="server"></asp:TextBox>
                            </td>
                            <td>
                ...
                <asp:GridView ID="gvLists" name="contents" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:LinkButton ID="hySign" OnClientClick='<%#"return PopSignEdit(this, " + Eval("ID").ToString()+");"%>' Text="签收" runat="server"></asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle CssClass="center" Width="4%" />
                        </asp:TemplateField>
                    </Columns>
