...
{
    public partial class MyNotSignUserSalary_Lst : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            //    SysClass.SysUserSalary.UserSalary_FlgValue += 4;
            //}
            //if (SysClass.SysUserSalary.UserSalary_FlgValue == 0)
            //{
            //    hasError = true;
            //    Dialog.OpenDialogInAjax(txtSalaryYears, "请至少勾选一项【查询包含项目】！");
            //}
            //Add by lk 20160118 end
    ...
    + " And a.SalaryRecGuid in (Select SalaryRecGuid From UserUserImportRec_Info where ApprovalStatus=1)";
            ...
            for (int iLoop = 0; iLoop < ds.Tables[0].Rows.Count; iLoop++)
            {
                ...
                dr[6] = ds.Tables[0].Rows[iLoop]["Description"].ToString();
