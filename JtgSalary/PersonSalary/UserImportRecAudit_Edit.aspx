<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserImportRecAudit_Edit.aspx.cs" Inherits="JtgTMS.DepotTool.UserImportRecAudit_Edit" %>
                    ...
                    <tr>
                        <td colspan="2" align="center" valign="top">
                             <table class="table-noborder table-hover" width="98%">
                                <tr>
                                  <td width="120" valign="top">导入日期：</td>
                                  <td align="left" valign="top">
                                       <asp:Literal ID="ltSalaryDates" runat="server"></asp:Literal>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td  align="left">
                                        <asp:RadioButtonList ID="rbApprovalStatus" RepeatDirection="Vertical" runat="server">                                        
                                            <asp:ListItem Value="1" Selected="True" Text="审核成功"></asp:ListItem>
                                        </asp:RadioButtonList>
                                  </td>
                                </tr>                                
                              </table>
                        ...
                        <td width="20"></td>
                            <td>
                                <div class="moda1l-footer">
                                    ...
                                    <button type="button" class="btn" id="Button2" onclick="closeWindow()" aria-hidden="true">
                                        关 闭</button>
                                </div>
                            </td>
