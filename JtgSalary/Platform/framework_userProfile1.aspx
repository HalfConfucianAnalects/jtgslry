<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="framework_userProfile1.aspx.cs" Inherits="JtgTMS.Platform.framework_userProfile1" %>
...
<body>
    ...
    <ul class="nav nav-pills" style="display:no1ne">    
        <li><a href="framework_userProfile.aspx"><lan>个人资料</lan></a></li>
        <li class="active"><a href="framework_userProfile1.aspx"><lan>录入资料</lan></a></li>
      </ul>
            ...
            <table class="table noborder table-hover" cellpadding="0" cellspacing="0">
             ...
             <asp:DataList ID="dlList" runat="server" CssClass="table noborder table-hover" RepeatColumns="2" Width="830" RepeatDirection="Horizontal"
                ...
                <ItemTemplate>
                    ...
                    <td width="250">
                        <ucCustomExtEdit:CustomExtEdit ID="WorklogExtEdit1" UserFieldType='<%# Eval("FieldType").ToString() %>' UserIsReadOnly='<%# Eval("IsReadOnly").ToString() %>' UserFieldName='<%# Eval("UserFieldname").ToString() %>' runat="server" />
                    </td>
                </ItemTemplate>
            </asp:DataList>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label1" runat="server" Text="*注意：若要更换绑定手机号，请在app上更改！" Font-Bold="False" Font-Italic="True" ForeColor="#FF3300"></asp:Label>
            <hr />
