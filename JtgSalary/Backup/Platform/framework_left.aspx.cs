        ...
        private void BindPageData()
        {
            ...
            while (sdr.Read())
            {
                ...
                if (_PurviewTag <= 0 || CyxPack.UserCommonOperation.UserCommonOperation.PurviewByID(_PurviewTag, ""))
                {
                    ...
                    + " <td nowrap>"
                    + "     <img align='absmiddle' style='cursor:pointer;' onClick='displayChildren(this);' isOpen='true' src='" + sdr["ImageUrl"].ToString() + "'/><img align='absmiddle' src='/sitefiles/bairong/Icons/menu/forum.gif'/>&nbsp;" + sdr["FuncTitle"]
                    + "	 </td>"
                    + "</tr>";
                        ...
                        if (_PurviewTag1 <= 0 || CyxPack.UserCommonOperation.UserCommonOperation.PurviewByID(_PurviewTag1, ""))
                        {
                            if (sdr1["NavigateUrl"].ToString().Length > 0)
                            {
                                ...
                                ltFunc.Text += " <td nowrap>"
                                    ...
                                    + " src='/sitefiles/bairong/icons/tree/empty.gif' /><img align='absmiddle' src='" + sdr1["ImageUrl"].ToString() + "' />&nbsp;"
