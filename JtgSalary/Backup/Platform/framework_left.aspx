...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
  	<ul class="nav">
	  <li><a href="#" style="font-size:14px; padding-left:20px;"><asp:Label ID="lbModuleTitle" runat="server"></asp:Label></a></li>
	</ul>
  </div>
</div>
</div>
...
<!-- check for 3.6 html permissions --><script type="text/javascript">
