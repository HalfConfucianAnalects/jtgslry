<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="framework_right.aspx.cs" Inherits="JtgTMS.Platform.framework_right" %>
...
<body>
 <form name="ctl00" method="post" runat="server" action="background_face.aspx" id="ctl00" class="form-inline">

  <div class="well well-small">
    <table class="table table-noborder">
      <tr>
        <td>
          欢迎使用 上海动车段 TMS 工资电子签收系统。    <a href="../upload/条码打印工具.exe">下载条码打印工具</a>
        </td>
      </tr>
    </table>
  </div>
  ...
  <table class="table noborder table-hover">
        <tr>
            <td width="50%">
                ...
                <h3 class="popover-title">我领用的工具</h3>
                        ...
                        <asp:GridView ID="gvLists" name="contents" runat="server" CssClass="table noborder table-hover"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="名称">
                                    <ItemTemplate>
                                        <asp:Label ID="lblToolName" Text='<%# Eval("ToolName").ToString()%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="10%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="数量">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQuantity" Width="88%" Text='<%# Eval("Quantity").ToString()%>' runat="server"></asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="3%" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="条码">
                                    <ItemTemplate>
                                        <%# Eval("ToolCode").ToString()%>
                                    </ItemTemplate>
                                    <ItemStyle Width="8%" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="领用时间">
                                    <ItemTemplate>
                                        <%# Eval("ConsumeDate").ToString().Length > 0 ? DateTime.Parse(Eval("ConsumeDate").ToString()).ToString("yyyy-MM-dd") : ""%>
                                    </ItemTemplate>
                                    <ItemStyle Width="10%" />
                                </asp:TemplateField>
                            </Columns>
            ...
            <td width="50%">
                <div class="popover popover-static">
                    <h3 class="popover-title">我借用的工具</h3>
                    <div class="popover-content">  
                        ...
                        <asp:GridView ID="gvApprovaling" name="contents" runat="server" CssClass="table noborder table-hover"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="申请状态">
                                    <ItemTemplate>
                                        <asp:Label ID="lblApprovalStatus" Text='<%# Eval("n").ToString()%>'  Visible="false" runat="server"></asp:Label>
                                        <a href="#" onclick='PopToolApprovalLog(this, <%# Eval("ID").ToString()%>)'><asp:Label ID="lblApprovalStatusName" Text='<%# Eval("n").ToString()%>' runat="server"></asp:Label></a>
                                    </ItemTemplate>
                                    <ItemStyle Width="6%" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="审批人">
                                    <ItemTemplate>
                                        <%# Eval("ApprovalUserID").ToString()%>
                                    </ItemTemplate>
                                    <ItemStyle Width="6%" />
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="">
                                    <ItemTemplate>
                                        <a id="hyEdit" href='../InterPhoneApproval/ApprovialLook.aspx?ReturnPageType=1&OrderID=<%# Eval("ID").ToString()%>'>查看</a>
                                    </ItemTemplate>
