<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Organ_Tree.aspx.cs" EnableEventValidation="false" Inherits="JtgTMS.Admin.Organ_Tree" %>
        ...
        <table class="table noborder table-condensed table-hover">
            <tr class="info">
              <td style="padding-left:50px;">
                <a href="Organ_Tree.aspx?POrganID=<% =_POrganID %>" target="tree" target="department">车间管理(刷新)</a></td>
            </tr>
            <tr>
              <td></td>
            </tr>
