<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier_Edit.aspx.cs" Inherits="JtgTMS.Admin.Supplier_Edit" %>
                        ...
                        <table class="table noborder">
                          <tr>
                            <td class="center">
                                ...
                                <input type="submit" name="btnReturn" value="返 回" onclick="location.href='Supplier_Lst.aspx?PSupplierID=<% =_PSupplierID %>';return false;" id="btnReturn" class="btn" />
                            </td>
                          </tr>
                        </table>
