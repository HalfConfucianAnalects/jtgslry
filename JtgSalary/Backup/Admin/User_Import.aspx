<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Import.aspx.cs" Inherits="JtgTMS.Admin.User_Import" %>
...
<form id="upForm" name="ctl00" class="form-inline" runat="server">
  <ul class="breadcrumb" style="display:none"><li>用户管理 <span class="divider">/</span></li><li>用户导入</ul>
            ...
            <ContentTemplate>
                ...
                <table class="table table-noborder">
                  <tr>
                    ...
                    <td width="330">
                        <asp:TextBox ID="txtOrganName" Width="120px" runat="server" ReadOnly="true"
                                        ></asp:TextBox>
                    </td>
                    <td>
              ...
              <asp:DropDownList ID="ddlTargetName" Visible="false" runat="server">
                ...
                <asp:ListItem Value="OpCode" Text="工资号"></asp:ListItem>
                <asp:ListItem Value="OpCode" Text="工号"></asp:ListItem>
                <asp:ListItem Value="OpName" Text="姓名"></asp:ListItem>
                <asp:ListItem Value="IDNumber" Text="身份证号"></asp:ListItem>
                <asp:ListItem Value="IsCanLogin" Text="在职状态"></asp:ListItem>
                <asp:ListItem Value="Sex" Text="性别"></asp:ListItem>
                <asp:ListItem Value="Organ" Text="单位"></asp:ListItem>
              </asp:DropDownList>
              
              <asp:GridView ID="gvAbnormal" name="contents" Visible="false" runat="server" CssClass="table table-bordered info table-hover"  GridLines="none"
