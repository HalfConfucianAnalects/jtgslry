<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserNotSignSalary_Lst.aspx.cs" Inherits="JtgTMS.PersonSalary.UserNotSignSalary_Lst" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PopSalaryEdit(_this, _id) {
            $(_this).openDOMWindow({
                width: 900,
                height: 600,
                borderSize: 1,
                ...
                modal: 1,
                windowSource: 'iframe',
                windowSourceURL: '../PersonSalary/UserSalary_Edit.aspx?UserSalaryID=' + _id.toString(),
                windowPadding: 0
            });
            return false;
        }
...
<form id="upForm" name="ctl00" class="form-inline" runat="server">
  <ul class="breadcrumb" style="display:none"><li>段工资签收 <span class="divider">/</span></li><li>未签收工资单</ul>
            ...
            <ContentTemplate>
                ...
                <table class="table table-noborder">
                  <tr>
                    ...
                    <td>
                        工资月份：
                      <asp:TextBox ID="txtSalaryYears" onClick="WdatePicker({dateFmt:'yyyyMM'})" MaxLength="6" Width="120px" runat="server"></asp:TextBox>
                ...
                <asp:GridView ID="gvLists" name="contents" runat="server" CssClass="table table-bordered info table-hover"  GridLines="none"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:LinkButton ID="hyView1" OnClientClick='<%#"return PopSalaryEdit(this, " + Eval("ID").ToString()+");"%>' text="编辑" runat="server"></asp:LinkButton>
                                <asp:HyperLink ID="hyEdit" NavigateUrl='<%# "../PersonSalary/UserSalary_Edit.aspx?ReturnPageType=3&UserSalaryID="+Eval("ID").ToString()%>' Text="编辑" Visible="false" runat="server"></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle CssClass="center" Width="4%" />
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="">
              ...
              <ul class="breadcrumb breadcrumb-button">    
                <asp:Button ID="btnAdd" Text="录入" Visible="false" CssClass="btn" runat="server" 
                      onclick="btnAdd_Click"  />
                <%--<asp:Button ID="btnExport" Text="导出Excel" CssClass="btn" 
                      runat="server" onclick="btnExport_Click"/>--%>
                <asp:Button ID="btnDelete" Text="删除" CssClass="btn" runat="server" OnClientClick="return confirm('此操作将删除所选的领用单，确认吗？')" 
