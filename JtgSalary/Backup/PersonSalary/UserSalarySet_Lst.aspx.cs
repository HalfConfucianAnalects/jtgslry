...
namespace JtgTMS.PersonSalary
{
    public partial class UserSalarySet_Lst : System.Web.UI.Page
    {
        ...
        private void BindPageData()
        {
            ...
            {
                sWhereSQL += " And (BeginYears Like '%" + txtSearchKeyword.Text + "%' OR BeginYears Like '%" + txtSearchKeyword.Text + "%')";
            }

            this.PageInfo.InnerHtml = SysClass.SysPageNums.GetPageRawUrlNum(SysClass.SysUserSalary.GetUserSalarySetLstByDataSet(""), gvLists, 15);
        }        
