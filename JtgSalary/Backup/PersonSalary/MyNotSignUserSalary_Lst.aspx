...
<form id="upForm" name="ctl00" class="form-inline" runat="server">
  <%--<ul class="breadcrumb" style="display:none"><li>段工资签收 <span class="divider">/</span></li><li>未工资领用</ul>--%>
    ...
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                ...
                <li class="active"><a href="MyNotSignUserSalary_Lst.aspx"><lan>未签收工资单</lan></a></li>
                <li><a href="MySignUserSalary_Lst.aspx"><lan>已签收工资单</lan></a></li>
              </ul>
