<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo_Choice.aspx.cs" Inherits="JtgTMS.BasicData.UserInfo_Choice" %>
                                ...
                                <div class="we1ll well1-small">
                                        <table class="table table-noborder">
                                          ...
                                          <tr>
                                            <td>
                                                关键字：
                                            <asp:DropDownList ID="ddpSearchName" Width="80" runat="server">
                                                <asp:ListItem Text="无" Value=""></asp:ListItem>
                                                <asp:ListItem Text="工号" Value="OpCode"></asp:ListItem>
                                                <asp:ListItem Text="姓名" Value="OpName"  Selected="True"></asp:ListItem>
                                          </asp:DropDownList>
