<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Tree.aspx.cs" EnableEventValidation="false" Inherits="JtgTMS.Admin.User_Tree" %>
        ...
        <table class="table noborder table-condensed table-hover">
            <tr class="info">
              <td style="padding-left:50px;">
                <a href="User_Tree.aspx?POrganID=<% =_POrganID %>" target="tree" target="department">部门管理(刷新)</a></td>
            </tr>
            <tr>
              <td></td>
            </tr>
          ...
          <asp:TreeView ID="tvList" runat="server" CssClass="treelist-condensed table-hover" NodeStyle-Height="20" Width="100%" ExpandDepth="1" ShowCheckBoxes="None" ShowLines="True" 
