<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dept_Edit.aspx.cs" Inherits="JtgTMS.Admin.Dept_Edit" %>
                        ...
                        <table class="table noborder">
                          <tr>
                            <td class="center">
                                ...
                                <input type="submit" name="btnReturn" value="返 回" onclick="location.href='Dept_Lst.aspx?POrganID=<% =_POrganID %>';return false;" id="btnReturn" class="btn" />
                            </td>
                          </tr>
                        </table>
