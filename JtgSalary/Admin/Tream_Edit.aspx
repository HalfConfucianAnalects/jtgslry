<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tream_Edit.aspx.cs" Inherits="JtgTMS.Admin.Tream_Edit" %>
                  ...
                  <h3 class="popover-title">编辑用户</h3>
                      <div class="popover-content">
                        ...
                        <table class="table noborder table-hover">      
                          <tr>
                            <td width="150px">所属班组：</td>
                            <td>
                                <asp:DropDownList ID="ddlPOrganID" Enabled="false" runat="server">
                                </asp:DropDownList>
                        ...
                        <table class="table noborder">
                          <tr>
                            <td class="center">
                                ...
                                <input type="submit" name="btnReturn" value="返 回" onclick="location.href='Tream_Lst.aspx?POrganID=<% =_POrganID %>';return false;" id="btnReturn" class="btn" />
                            </td>
                          </tr>
                        </table>
