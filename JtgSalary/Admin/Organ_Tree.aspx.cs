...
{
    public partial class Organ_Tree : System.Web.UI.Page
    {
        ...
        {
            SqlDataReader sdr = SysClass.SysOrgan.GetOrganLstByReader(PID, SysClass.SysOrgan.OrganType_Value);
            while (sdr.Read())
            {
                ...
                tnNode.NavigateUrl = "Organ_Lst.aspx?POrganID=" + tnNode.Value; ;
