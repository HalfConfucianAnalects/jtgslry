                ...
                <asp:UpdatePanel ID="upForm" runat="server">
                    ...
                    <ContentTemplate> 
                        ...
                        <table>
                            <tr>
                                <td>
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/Pic/Android_download.png" Height="200px" Width="200px" />

                                </td>
                                <td></td>
                               <td>
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Pic/IOS_download.png" ToolTip="200" Width="200px" />
