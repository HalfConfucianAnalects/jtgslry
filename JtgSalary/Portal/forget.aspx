<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forget.aspx.cs" Inherits="JtgTMS.Platform.forget" %>
...
<body>
  ...
  <h3 class="popover-title"><lan>初始密码必须修改</lan></h3>
        ...
        <table class="table noborder">
          <tr>
            <td class="center">
              ...
              <asp:Button ID="btnBack" class="btn" OnClick="btnBack_Click" CausesValidation="false" runat="server" Text="退出"  />
            </td>
          </tr>
        </table>
